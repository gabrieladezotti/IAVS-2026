...
To reproduce the project:
    Open the project in RStudio or VS Code with R support enabled.
    Restore the project environment with renv::restore().
    Render the Quarto document poster_iavs2026.qmd.


This project is organized to support reproducibility and FAIR-oriented practices:
    Findable: clear folder structure and descriptive file names.
    Accessible: plain-text scripts and documentation.
    Interoperable: preference for open tabular formats such as .csv when possible.
    Reusable: analytical steps are documented in code rather than performed manually.
